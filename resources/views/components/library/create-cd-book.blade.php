    ...
    $(document).ready(function() {
        ...
        function addRow() {
            var newRow = `<tr>
                ...
                <td>
                    <textarea name="information[]" type="text" class="form-control" id="information" cols="10" rows="1"></textarea>
                </td>
                <td>
                    <textarea name="progress[]" type="number" class="form-control" id="progress" cols="10" rows="1"></textarea>
                </td>
                <td>
