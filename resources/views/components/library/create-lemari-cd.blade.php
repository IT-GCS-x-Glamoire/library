...
<div class="container-fluid">
        ...
        <div class="col">
            <nav aria-label="breadcrumb" class="bg-white rounded-3 p-3 mb-4">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Lemari CD</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <!-- Filter dan Search -->
            <form action="{{ route('library.lemari.cd') }}" method="GET" class="mb-4" enctype="multipart/form-data">
                <div class="row">
                    {{-- <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group mt-2">
                                ...
                                <a href="{{ route('library.lemari.cd') }}" class="btn btn-secondary">
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Tambah data lemari CD</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" action="{{route('store.lemari.cd')}}" enctype="multipart/form-data">
                    @csrf
...
<div class="modal fade" id="modalUpdateData" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('update.lemari.cd') }}" enctype="multipart/form-data">
                    @csrf
...
<script>
    ...
    $(document).on('click', '#deleteData', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ route('delete.lemari.cd', ':id') }}".replace(':id', id),
                    type: 'DELETE',
                    data: {
                        exam_id: id,
                        _token: '{{ csrf_token() }}'
    ...
    $(document).on("click", ".btn-edit", function () {
        ...
        $.ajax({
            url: "/data/lemari-cd/edit/" + id, // Panggil route Laravel
            type: "GET",
            dataType: "json",
            success: function (response) {
                if (response.data) {
