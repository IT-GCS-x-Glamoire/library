...
<div class="container-fluid">
        ...
        <div class="col">
            <nav aria-label="breadcrumb" class="bg-white rounded-3 p-3 mb-4">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Kurikulum Lama</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card mt-4">
        <div class="card-header">
            <h3>Kurikulum Lama</h3>
        </div>
        <div class="card-body">
            <!-- Filter dan Search -->
            <form action="{{ route('library.curriculum.old') }}" method="GET" class="mb-4" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group mt-2">
                                ...
                                <a href="{{ route('library.curriculum.old') }}" class="btn btn-secondary">
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    <form method="POST" action="{{route('store.curriculum.old')}}" enctype="multipart/form-data">
                    @csrf
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody id="scheduleTableBody">
                                    <tr>
                                        ...
                                        <td>
                                            <input name="total[]" type="number" class="form-control" id="number">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm btn-hapus mt-1" title="Hapus Baris" id="hapus"><i class="fa fa-times"></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="card p-2 bg-light">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm btn-hapus mt-1 d-none" title="Hapus Baris" id="hapus">Hapus <i class="fa fa-times"></i></button>
                                </div>
                                <div class="col-6">
                                    <div class="form-group mb-3">
...
<div class="modal fade" id="modalUpdateData" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('update.curriculum.old') }}" enctype="multipart/form-data" class="row">
                    @csrf
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <label for="subject">Subject</label>
                            <input name="subject" type="text" class="form-control" id="subject-update" required>
                        </div>
...
<script>
    ...
    $(document).on('click', '#deleteData', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ route('delete.curriculum.old', ':id') }}".replace(':id', id),
                    type: 'DELETE',
                    data: {
                        exam_id: id,
                        _token: '{{ csrf_token() }}'
    ...
    $(document).on("click", ".btn-edit", function () {
        ...
        $.ajax({
            url: "/data/curriculum-old/edit/" + id, // Panggil route Laravel
            type: "GET",
            dataType: "json",
            success: function (response) {
                if (response.data) {
                    ...
                    $("#subject-update").val(response.data.subject);
